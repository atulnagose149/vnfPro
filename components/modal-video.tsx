...
//             src={"https://vnfassets.s3.ap-south-1.amazonaws.com/sddefault.jpg"}
//             width={thumbWidth}
//             height={thumbHeight}
//             priority
//             alt={thumbAlt}
...
//               >
//                 <source
//                   src="https://vnfassets.s3.ap-south-1.amazonaws.com/CoronaMedicine.mp4"
//                   type="video/mp4"
//                 />
...
import { Navigation, Pagination, Autoplay } from "swiper"; // Added Autoplay module
import "swiper/css";
          ...
          {images.map((img, index) => (
            <SwiperSlide key={index}>
              <div
                ...
                onMouseLeave={() => swiperRef.current?.autoplay.start()} // Restart autoplay on mouse leave
              >
                <Image
